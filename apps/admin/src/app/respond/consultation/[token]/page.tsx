...
const responseSchema = z
  .object({
    response_type: z.enum(['positive', 'negative']),
...
function TokenExpiredPage() {
  return (
    <StatusCard
      ...
      message="Bu danışma bağlantısının geçerlilik süresi dolmuştur. Lütfen kurum ile iletişime geçiniz."
      variant="warning"
    />
  );
}
...
export default function ConsultationRespondPage() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`${API_URL}/consult/respond/${token}`)
      .then((res) => {
  ...
  const onSubmit = async (values: ResponseFormValues) => {
    ...
    try {
      const res = await axios.post(`${API_URL}/consult/respond/${token}`, {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-12">
      <div className="max-w-lg w-full bg-white rounded-xl shadow-sm border border-gray-200 p-8">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-900">Üye Danışma Formu</h1>
        ...
        {formData && (
          <div className="mb-6 bg-gray-50 rounded-lg p-4 text-sm space-y-1">
            ...
            <div>
              <span className="font-medium text-gray-700">Danışılan Üye: </span>
              <span className="text-gray-900">{formData.member_name}</span>
            </div>
            <div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          <fieldset>
            <legend className="text-sm font-semibold text-gray-700 mb-3">
              Bu başvuran hakkındaki görüşünüz nedir?
            </legend>
            ...
            <div className="space-y-3">
              ...
              <label className="flex items-start gap-3 cursor-pointer group">
                ...
                <div>
                  ...
                  <span className="block text-xs text-gray-500">
                    Bu kişi hakkında olumlu bir görüşüm bulunmaktadır.
                  </span>
                </div>
              </label>
              ...
              <label className="flex items-start gap-3 cursor-pointer group">
                ...
                <div>
                  ...
                  <span className="block text-xs text-gray-500">
                    Bu kişi hakkında olumsuz bir görüşüm bulunmaktadır.
                  </span>
                </div>
              </label>
            </div>
